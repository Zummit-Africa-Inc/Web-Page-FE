    ...
    <Box component='section'
        ...
        <Grid container spacing={2}>
            ...
            <Grid item sm={12} md={6}>
                ...
                <PrimaryButton color= '#09090B' bgcolor='#FFEA00' marginTop='10rem' isDesktop={isDesktop}>
                    Contact us <img src={ReactLogo} alt="React Logo" style={{paddingLeft:'.5rem', height: '1.2rem', width: '1.2rem'}}/>
                </PrimaryButton> 
            </Grid>
        </Grid>
    </Box>
