    ...
    return (
        ...
        borderRadius: '30px',}}>
                ...
                >
                    ...
                    <Typography className={classes.boxParagraph} variant='p' 
                        sx={{fontWeight: '400',
                        fontSize: '20px',
                        lineHeight: '30px',
                        color: '#ECF2FD',}}
                    ...
                    <Stack direction='row' spacing={2} className='buttons'>
                        <Button variant='contained' disableRipple className='enroll-btn' sx={{width:' 205px',
    height: '60px',
    background: '#FFEA00',
    borderRadius: '10px',
    color: '#081F4A'}}>Enroll Now</Button>
                        <Button variant='outlined' disableRipple className='get-btn' sx={{width: '191px',
    height: '60px',
    border: '1px solid #FFEA00',
    borderRadius: '10px',
    color: '#FFEA00'}}>Get in touch</Button>
                    </Stack>
                </Stack>
                <Stack>
